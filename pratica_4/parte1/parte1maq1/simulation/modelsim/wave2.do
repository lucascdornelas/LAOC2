...
add wave -noupdate -radix unsigned -childformat {{{/parte1maq1/estado[1]} -radix unsigned} {{/parte1maq1/estado[0]} -radix unsigned}} -subitemconfig {{/parte1maq1/estado[1]} {-height 15 -radix unsigned} {/parte1maq1/estado[0]} {-height 15 -radix unsigned}} /parte1maq1/estado
add wave -noupdate -radix unsigned -childformat {{{/parte1maq1/mensagem[1]} -radix unsigned} {{/parte1maq1/mensagem[0]} -radix unsigned}} -subitemconfig {{/parte1maq1/mensagem[1]} {-height 15 -radix unsigned} {/parte1maq1/mensagem[0]} {-height 15 -radix unsigned}} /parte1maq1/mensagem
add wave -noupdate -radix unsigned -childformat {{{/parte1maq1/acao[1]} -radix unsigned} {{/parte1maq1/acao[0]} -radix unsigned}} -subitemconfig {{/parte1maq1/acao[1]} {-height 15 -radix unsigned} {/parte1maq1/acao[0]} {-height 15 -radix unsigned}} /parte1maq1/acao
